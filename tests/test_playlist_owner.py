...
Drives production get_user_playlists and GET / through the real FastAPI app.
Token/storage/network seams are patched; no live Spotify calls.
"""
import unittest
...
class PlaylistOwnerLabelTests(unittest.TestCase):
    def test_null_display_name_uses_owner_id(self):
        self.assertEqual(
            main.playlist_owner_label({"id": "fixture-owner", "display_name": None}),
            "fixture-owner",
        )

    def test_display_name_is_preserved(self):
        self.assertEqual(
            main.playlist_owner_label({"id": "fixture-owner", "display_name": "Fixture Owner"}),
            "Fixture Owner",
        )

    def test_empty_display_name_is_preserved(self):
        self.assertEqual(
            main.playlist_owner_label({"id": "fixture-owner", "display_name": ""}),
            "",
        )
